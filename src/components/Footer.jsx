...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#800080] pt-16 pb-8">
      <div className="container mx-auto px-5 py-16 flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col border-y-2 border-white">
